...
if(MODS.includes(this.format)) this.dex = Dex.mod(this.format)
...
if(MODS.includes(this.format))table=table[this.format];
...
if(MODS.includes(this.format))lsetTable=lsetTable[this.format];
